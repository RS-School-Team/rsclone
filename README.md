...
## Тематика приложения
CRM-система, которая будет включать:
...
Контекстное меню на правом клике


##### Технический стек:
* Использован Canvas/WebGL/etc (20 баллов)
?библиотека svg-анимация

* Работа с Audio API (10 баллов)
?Возможность голосового ввода, озвучивание текста - какое апи используется
